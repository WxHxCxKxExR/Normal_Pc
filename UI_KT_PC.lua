...
if _G.Color == nil then _G.Color = Color3.fromRGB(255, 0, 89) end
if _G.Color2 == nil then _G.Color2 = Color3.fromRGB(255, 0, 89) end
-- Services
        ...
        function tab:CreateSector(name, side)
            ...
            function sector:AddToggle(text, default, callback, flag)
                ...
                function toggle:AddKeybind(default, flag)
                    local keybind = { }
                    keybind.default = Enum.KeyCode[default] or "None"
                    ...
                    function keybind:Set(key)
                        ...
                        keybind.Main.Text = "[" .. (shorter_keycodes[tostring(Enum.KeyCode[key])] or tostring(Enum.KeyCode[key])) .. "]"
                        keybind.value = Enum.KeyCode[key]
                        if keybind.flag and keybind.flag ~= "" then
