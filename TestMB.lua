...
function LV()
            ...
            return {
                {
                    ...
                    PM = CFrame.new(-4968.62158203125, 34.187774658203125, 4027.792236328125),
                    PM2 = CFrame.new(-4733.76220703125, 37.00742721557617, 4536.3076171875),
            ...
            return {
                {
                    ...
                    NameMon = "Gladiator",
                    POSQ = CFrame.new(-1580.05, 6.35, -2986.48),
                    PM = CFrame.new(-1338.4744873046875, 7.389348983764648, -3490.5517578125),
                    PM2 = CFrame.new(-1215.825927734375, 7.289083480834961, -3106.006103515625),
                    SPAWNPOINT = "Colosseum",
                    Warp = {
                        Use = false,
                        Position =  nil,
            ...
            return {
                {
                    ...
                    PM = CFrame.new(382.4712829589844, 39.139930725097656, 2329.23095703125),
                    PM2 = CFrame.new(-709.5562133789062, 39.13979721069336, 2371.967041015625),
                    SPAWNPOINT = "Default",
                    Warp = {
                        Use = false,
                        Position =  nil,
    ...
    if ThirdWorld then
        ...
        elseif lv == 2425 or lv <= 2450 then
            return {
                {
                            ...
                            coroutine.wrap(function()
                                pcall(function()
                                    if i == 2 then
                                        ...
                                        CombatFrameworkR.activeController.timeToNextAttack = -999
            ...
            if _G.AutoFarmObservation or _G.AutoFarmObservationHop then
                ...
                if NewWorld then
                    if game:GetService("Workspace").Enemies:FindFirstChild("Lava Pirate [Lv. 1200]") then
                        if game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("ImageLabel") then
                            repeat task.wait()
                                game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace").Enemies:FindFirstChild("Lava Pirate [Lv. 1200]").HumanoidRootPart.CFrame * CFrame.new(3,0,0)
                            ...
                            repeat wait()
                                game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace").Enemies:FindFirstChild("Lava Pirate [Lv. 1200]").HumanoidRootPart.CFrame * CFrame.new(0,0,0)
                                wait(2)
                ...
                elseif OldWorld then
                    if game:GetService("Workspace").Enemies:FindFirstChild("Galley Captain [Lv. 650]") then
                        if game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("ImageLabel") then
                            repeat task.wait()
                                game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace").Enemies:FindFirstChild("Galley Captain [Lv. 650]").HumanoidRootPart.CFrame * CFrame.new(3,0,0)
                            until _G.AutoFarmObservation == false or not game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("ImageLabel")
                        else
                            repeat wait()
                                game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace").Enemies:FindFirstChild("Galley Captain [Lv. 650]").HumanoidRootPart.CFrame * CFrame.new(0,0,0)
                                wait(2)
                                if not game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("ImageLabel") and _G.AutoFarmObservationHop == true then
                                    game:GetService("TeleportService"):Teleport(game.PlaceId,game:GetService("Players").LocalPlayer)
                                end
                ...
                elseif ThirdWorld then
                    if game:GetService("Workspace").Enemies:FindFirstChild("Female Islander [Lv. 1625]") then
                        if game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("ImageLabel") then
                            repeat task.wait()
                                game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace").Enemies:FindFirstChild("Female Islander [Lv. 1625]").HumanoidRootPart.CFrame * CFrame.new(3,0,0)
                            until _G.AutoFarmObservation == false or not game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("ImageLabel")
                        else
                            repeat wait()
                                game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace").Enemies:FindFirstChild("Female Islander [Lv. 1625]").HumanoidRootPart.CFrame * CFrame.new(0,0,0)
                                wait(2)
                ...
                if game.Players.LocalPlayer.Data.Level.Value > 9 and game.Players.LocalPlayer.Data.Level.Value <= 49 then
                    repeat wait()
                        if (game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position - Vector3.new(-4607.82275, 872.54248, -1667.55688)).Magnitude <= 5000 then
                            ...
                            elseif game:GetService("ReplicatedStorage"):FindFirstChild("God's Guard [Lv. 450]") then
                                topos(game:GetService("ReplicatedStorage"):FindFirstChild("God's Guard [Lv. 450]").HumanoidRootPart.CFrame * CFrame.new(0,25,0))
                            else
                ...
                elseif game.Players.LocalPlayer.Data.Level.Value > 79 and game.Players.LocalPlayer.Data.Level.Value <= 119 then
                    repeat wait()
                        if (game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position - Vector3.new(-7894.6176757813, 5547.1416015625, -380.29119873047)).Magnitude <= 5000 then
                            ...
                            elseif game:GetService("ReplicatedStorage"):FindFirstChild("Royal Squad [Lv. 525]") then
                                topos(game:GetService("ReplicatedStorage"):FindFirstChild("Royal Squad [Lv. 525]").HumanoidRootPart.CFrame * CFrame.new(0,25,0))
                            elseif game:GetService("Workspace").Enemies:FindFirstChild("Royal Soldier [Lv. 550]") then
                                for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            ...
                            elseif game:GetService("ReplicatedStorage"):FindFirstChild("Royal Soldier [Lv. 550]") then
                                topos(game:GetService("ReplicatedStorage"):FindFirstChild("Royal Soldier [Lv. 550]").HumanoidRootPart.CFrame * CFrame.new(0,25,0))
                            else
                        ...
                        repeat wait()
                            ...
                            if game:GetService("Players").LocalPlayer.Data.LastSpawnPoint.Value == v.SPAWNPOINT or v.Warp.Use then
                                if game.Players.LocalPlayer.PlayerGui.Main.Quest.Visible == false then
                                    if (v.POSQ.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude > 3 then
                                        repeat wait() topos(v.POSQ) until (v.POSQ.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 3
                                    end
                                    wait(.6)
                                    wait(.6)
                                    ...
                                    if string.find(game.Players.LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text,v.NameMon) then
                                        if game:GetService("Workspace").Enemies:FindFirstChild(v.Mon) then
                                                    ...
                                                    if z:FindFirstChild("Humanoid") and z:FindFirstChild("HumanoidRootPart") then
                                                        if z.Humanoid.Health > 0 then
                                                            repeat task.wait()
                                                                EquipWeapon(_G.Weapon)
                                                                Buso()
                                                                OldPosMon = z.HumanoidRootPart.CFrame
                                                            ...
                                                            until z.Humanoid.Health <= 0 or not z:FindFirstChild("Humanoid") or _G.AutoFarmLevel == false or not z:FindFirstChild("HumanoidRootPart") or game.Players.LocalPlayer.PlayerGui.Main.Quest.Visible == false or (game.Players.LocalPlayer.Data.Level.Value > 9 and game.Players.LocalPlayer.Data.Level.Value <= 49) 
                                                        end
                                                    end
                                                end
                                            end
                                            ...
                                            if game:GetService("ReplicatedStorage"):FindFirstChild(v.Mon) then
                                                ...
                                                if v.PM2 == nil then
                                                    if CheckMob(v.Mon) then
                                                        topos(game:GetService("Workspace")["_WorldOrigin"].EnemySpawns[v.Mon].CFrame * CFrame.new(0,20,0))
                                                    else
                                                        topos(v.PM)
                                                    end
                                                else
                                                    repeat wait()
                                                    topos(v.PM)
                                                    until (v.PM.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <3 or game:GetService("ReplicatedStorage"):FindFirstChild(v.Mon) or game:GetService("ReplicatedStorage"):FindFirstChild(v.Mon)
                                                    repeat wait()
                                                        topos(v.PM2)
                                                    until (v.PM2.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <3 or game:GetService("ReplicatedStorage"):FindFirstChild(v.Mon) or game:GetService("ReplicatedStorage"):FindFirstChild(v.Mon)
                                                end
                                            end
                                        end
                                    else
                                ...
                                repeat task.wait()
                                    ...
                                    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
                                    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = v.POSQ
                                until game:GetService("Players").LocalPlayer.Data.LastSpawnPoint.Value == v.SPAWNPOINT or not _G.AutoFarmLevel or (game.Players.LocalPlayer.Data.Level.Value > 9 and game.Players.LocalPlayer.Data.Level.Value <= 49)
                            end
                        until game.Players.LocalPlayer.PlayerGui.Main.Quest.Visible == false or _G.AutoFarmLevel == false or (game.Players.LocalPlayer.Data.Level.Value > 9 and game.Players.LocalPlayer.Data.Level.Value <= 49)
                    end
                end
            end
        end)
    ...
    while task.wait() do
        pcall(function()
            if _G.AutoFinishDoughDungeons then
                ...
                elseif game:GetService("ReplicatedStorage"):FindFirstChild("Dough King [Lv. 2300] [Raid Boss]") or game:GetService("Workspace").Enemies:FindFirstChild("Dough King [Lv. 2300] [Raid Boss]") then
                    if game:GetService("Workspace").Enemies:FindFirstChild("Dough King [Lv. 2300] [Raid Boss]") then
                        ...
                        if game:GetService("ReplicatedStorage"):FindFirstChild("Dough King [Lv. 2300] [Raid Boss]") then
                            topos(game:GetService("ReplicatedStorage"):FindFirstChild("Dough King [Lv. 2300] [Raid Boss]").HumanoidRootPart.CFrame * CFrame.new(0,40,0))
                        end
                    end
                                ...
                                if v.Name == "Cookie Crafter [Lv. 2200]" or v.Name == "Cake Guard [Lv. 2225]" or v.Name == "Baking Staff [Lv. 2250]" or v.Name == "Head Baker [Lv. 2275]" then
                                    if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                        repeat task.wait()
                                            ...
                                            topos(v.HumanoidRootPart.CFrame * CFrame.new(0,30,20))
                                            _G.FastAttack = true
                                        until not _G.AutoFinishDoughDungeons or not v.Parent or v.Humanoid.Health <= 0 or game:GetService("ReplicatedStorage"):FindFirstChild("Cake Prince [Lv. 2300] [Raid Boss]") or game:GetService("Workspace").Enemies:FindFirstChild("Cake Prince [Lv. 2300] [Raid Boss]")
                                        _G.FastAttack = false
                                    end
                                end
                            end
                ...
                elseif game:GetService("Workspace").Enemies:FindFirstChild("Diablo [Lv. 1750]") or game:GetService("Workspace").Enemies:FindFirstChild("Deandre [Lv. 1750]") or game:GetService("Workspace").Enemies:FindFirstChild("Urban [Lv. 1750]") then
                    for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
...
local Beli = Window:SetBeli("Beli",formatNumber(game:GetService("Players").LocalPlayer.Data.Beli.Value),Color3.fromRGB(255, 183, 0))
...
game:GetService("RunService").RenderStepped:Connect(function()
    Beli:Update("Beli",formatNumber(game:GetService("Players").LocalPlayer.Data.Beli.Value),Color3.fromRGB(255, 183, 0))
    Fragments:Update("Fragments",formatNumber(game:GetService("Players").LocalPlayer.Data.Fragments.Value),Color3.fromRGB(170, 85, 255))
    Bounty:Update("Bounty",formatNumber(game:GetService("Players").LocalPlayer.leaderstats["Bounty/Honor"].Value),Color3.fromRGB(255, 170, 0))
end)
end)
...
while task.wait() do
    if _G.AutoFarmBossHallow then
        pcall(function()
            ...
            elseif game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Hallow Essence") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Hallow Essence") then
                repeat topos(CFrame.new(-8932.322265625, 146.83154296875, 6062.55078125)) task.wait() until (CFrame.new(-8932.322265625, 146.83154296875, 6062.55078125).Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 8 or not SaveSettings["Main"]["AutoFarmBossHallow"] or game:GetService("ReplicatedStorage"):FindFirstChild("Soul Reaper [Lv. 2100] [Raid Boss]") or game:GetService("Workspace").Enemies:FindFirstChild("Soul Reaper [Lv. 2100] [Raid Boss]")
                EquipWeapon("Hallow Essence")
            else
                if game:GetService("ReplicatedStorage"):FindFirstChild("Soul Reaper [Lv. 2100] [Raid Boss]") then
                    topos(game:GetService("ReplicatedStorage"):FindFirstChild("Soul Reaper [Lv. 2100] [Raid Boss]").HumanoidRootPart.CFrame * CFrame.new(0,40,0))
                else
...
task.spawn(function()
    repeat task.wait()
        getTarget("Cake Queen [Lv. 2175] [Boss]", _G.AutoBuddySword, _G.AutoBuddySwordHOP)
    until not value
end)
end)
...
task.spawn(function()
    repeat task.wait()
        getTarget("Beautiful Pirate [Lv. 1950] [Boss]", _G.AutoCanvander, _G.AutoCanvanderHOP)
    until not value
end)
end)
        ...
        if _G.AutoDarkDagger then
            if game:GetService("Workspace").Enemies:FindFirstChild("rip_indra True Form [Lv. 5000] [Raid Boss]") or game:GetService("Workspace").Enemies:FindFirstChild("rip_indra [Lv. 5000] [Raid Boss]") then
                ...
                if game:GetService("ReplicatedStorage"):FindFirstChild("rip_indra True Form [Lv. 5000] [Raid Boss]") then
                    topos(game:GetService("ReplicatedStorage"):FindFirstChild("rip_indra True Form [Lv. 5000] [Raid Boss]").HumanoidRootPart.CFrame * CFrame.new(0,40,0))
                elseif game:GetService("ReplicatedStorage"):FindFirstChild("rip_indra [Lv. 5000] [Raid Boss]") then
                    topos(game:GetService("ReplicatedStorage"):FindFirstChild("rip_indra [Lv. 5000] [Raid Boss]").HumanoidRootPart.CFrame * CFrame.new(0,40,0))
                else
...
task.spawn(function()
    repeat task.wait()
        getTarget("Thunder God [Lv. 575] [Boss]", _G.AutoPoleVer1, _G.AutoPoleVer1HOP)
    until not value
end)
end)
            ...
            if game:GetService("Workspace").Map.Jungle.Final:FindFirstChild("Part").Transparency == 0 then
                ...
                if game:GetService("Workspace").Enemies:FindFirstChild("Saber Expert [Lv. 200] [Boss]") then
                    ...
                    if game:GetService("ReplicatedStorage"):FindFirstChild("Saber Expert [Lv. 200] [Boss]") then
                        topos(game:GetService("ReplicatedStorage"):FindFirstChild("Saber Expert [Lv. 200] [Boss]").HumanoidRootPart.CFrame * CFrame.new(0,40,0))
                    else
...
task.spawn(function()
    repeat task.wait()
        getTarget("Captain Elephant [Lv. 1875] [Boss]", _G.AutoTwinHooks, _G.AutoTwinHooksHop)
    until not value
end)
end)
...
task.spawn(function()
    repeat task.wait()
        getTarget("Island Empress [Lv. 1675] [Boss]", _G.AutoSerpentBow, _G.AutoSerpentBowHop)
    until not value
end)
end)
...
if OldWorld then
    if _G.Material == "Scrap Metal" then
        _G.Material = "Brute [Lv. 45]"
    elseif _G.Material == "Leather" then
        _G.Material = "Pirate [Lv. 35]"
    elseif _G.Material == "Angel Wings" then
        _G.Material = "Shanda [Lv. 475]"
    elseif _G.Material == "Fish Tail" then
        _G.Material = "Fishman Warrior [Lv. 375]"
    elseif _G.Material == "Magma Ore" then
        _G.Material = "Military Soldier [Lv. 300]"
    elseif _G.Material == "Radioactive Meterial" then
        _G.Material = "Factory Staff [Lv. 800]"
    elseif _G.Material == "Vampire Fang" then
        _G.Material = "Vampire [Lv. 975]"
    elseif _G.Material == "Mystic Droplet" then
        _G.Material = "Sea Soldier [Lv. 1425]"
    elseif _G.Material == "Dragon Scale" then
        _G.Material = "Dragon Crew Warrior [Lv. 1575]"
    elseif _G.Material == "Cocoa" then
        _G.Material = "Chocolate Bar Battler [Lv. 2325]"
    elseif _G.Material == "Demonic wisp" then
        _G.Material = "Demonic Soul [Lv. 2025]"
    elseif _G.Material == "Mirror Fractal" then
        _G.Material = "Cookie Crafter [Lv. 2200]"
    elseif _G.Material == "Mini Tusk" then
        _G.Material = "Mythological Pirate [Lv. 1850]"
    elseif _G.Material == "Gunpowder" then
        _G.Material = "Pistol Billionaire [Lv. 1525]"
    end
elseif NewWorld then
    if _G.Material == "Scrap Metal" then
        _G.Material = "Mercenary [Lv. 725]"
    elseif _G.Material == "Leather" then
        _G.Material = "Marine Captain [Lv. 900]"
    elseif _G.Material == "Angel Wings" then
        _G.Material = "Shanda [Lv. 475]"
    elseif _G.Material == "Fish Tail" then
        _G.Material = "Fishman Raider [Lv. 1775]"
    elseif _G.Material == "Magma Ore" then
        _G.Material = "Magma Ninja [Lv. 1175]"
    elseif _G.Material == "Radioactive Meterial" then
        _G.Material = "Factory Staff [Lv. 800]"
    elseif _G.Material == "Vampire Fang" then
        _G.Material = "Vampire [Lv. 975]"
    ...
    if _G.Material == "Scrap Metal" then
        _G.Material = "Pirate Millionaire [Lv. 1500]"
    elseif _G.Material == "Leather" then
        _G.Material = "Forest Pirate [Lv. 1825]"
    elseif _G.Material == "Angel Wings" then
        _G.Material = "Shanda [Lv. 475]"
    elseif _G.Material == "Fish Tail" then
        _G.Material = "Fishman Raider [Lv. 1775]"
                ...
                elseif QuestVis() then
                    if game:GetService("Workspace").Enemies:FindFirstChild("Diablo [Lv. 1750]") or game:GetService("Workspace").Enemies:FindFirstChild("Deandre [Lv. 1750]") or game:GetService("Workspace").Enemies:FindFirstChild("Urban [Lv. 1750]") then
                        ...
                        if game:GetService("ReplicatedStorage"):FindFirstChild("Diablo [Lv. 1750]") then
                            if ( game:GetService("ReplicatedStorage"):FindFirstChild("Diablo [Lv. 1750]").HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position ).Magnitude >= 2500 then
                                game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("ReplicatedStorage"):FindFirstChild("Diablo [Lv. 1750]").HumanoidRootPart.CFrame * CFrame.new(0,50,0)
                                wait(.5)
                                game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("ReplicatedStorage"):FindFirstChild("Diablo [Lv. 1750]").HumanoidRootPart.CFrame * CFrame.new(0,50,0)
                                game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("ReplicatedStorage"):FindFirstChild("Diablo [Lv. 1750]").HumanoidRootPart.CFrame * CFrame.new(0,50,0)
                        ...
                        elseif game:GetService("ReplicatedStorage"):FindFirstChild("Deandre [Lv. 1750]") then
                            if ( game:GetService("ReplicatedStorage"):FindFirstChild("Deandre [Lv. 1750]").HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position ).Magnitude >= 2500 then
                                game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("ReplicatedStorage"):FindFirstChild("Deandre [Lv. 1750]").HumanoidRootPart.CFrame * CFrame.new(0,50,0)
                                wait(.5)
                                game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("ReplicatedStorage"):FindFirstChild("Deandre [Lv. 1750]").HumanoidRootPart.CFrame * CFrame.new(0,50,0)
                                game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("ReplicatedStorage"):FindFirstChild("Deandre [Lv. 1750]").HumanoidRootPart.CFrame * CFrame.new(0,50,0)
                                game.Players.LocalPlayer.Character.Humanoid:ChangeState(15)
                        ...
                        elseif game:GetService("ReplicatedStorage"):FindFirstChild("Urban [Lv. 1750]") then
                            if ( game:GetService("ReplicatedStorage"):FindFirstChild("Urban [Lv. 1750]").HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position ).Magnitude >= 2500 then
                                game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("ReplicatedStorage"):FindFirstChild("Urban [Lv. 1750]").HumanoidRootPart.CFrame * CFrame.new(0,50,0)
                                wait(.5)
                                game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("ReplicatedStorage"):FindFirstChild("Urban [Lv. 1750]").HumanoidRootPart.CFrame * CFrame.new(0,50,0)
                                game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("ReplicatedStorage"):FindFirstChild("Urban [Lv. 1750]").HumanoidRootPart.CFrame * CFrame.new(0,50,0)
                                game.Players.LocalPlayer.Character.Humanoid:ChangeState(15)
...
while task.wait() do
    pcall(function()
        if _G.AutoFarmCandy then
            if not game:GetService("Workspace").Enemies:FindFirstChild("Snow Demon [Lv. 2425]") and not game:GetService("Workspace").Enemies:FindFirstChild("Candy Pirate [Lv. 2400]") then
...
Stats:AddDropdown("Select Status",nil,true,Statslist,function(value)
...
local Selcet_Players = Stats:AddDropdown("Select Player",nil,false,Playerslist,function(value)
...
Stats:AddDropdown("Select Code",nil,true,CodeList,function(value)
_G.SelectCode = value
end)
...
ListIsland = {"Mansion","Port Town", "Great Tree", "Castle On The Sea", "MiniSky", "Hydra Island","Floating Turtle","Haunted Castle","Sea of Treats 1","Sea of Treats 2","Sea of Treats 3"}
end
local Drop = Teleport:AddDropdown("Select Island",_G.SelectIsland,false,ListIsland,function(value)
...
local Drop = Dungeon:AddDropdown("Select Raid",_G.SelectRaid,false,ListRaid,function(value)
_G.SelectRaid = value
end)
